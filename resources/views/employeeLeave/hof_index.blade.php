                    ...
                    >
                      ...
                      <tbody>
                          ...
                          <tr>
                            ...
                            <td>{{$cols->reason}}</td>
                            @endif
                            <td>@if($cols->hou_status != null && $cols->hou_status != 0){{$cols->hou_status}}@elseif($cols->hou_status == null && $offcial->role != "HOU") I Am Not Authorized to Accept this Leave Request @elseif($cols->hou_status == null && $offcial->role == "HOU") I Can't Accept this Leave Request Because It's Mine @else Head Of Unit Does Not Exists @endif</td>
                            <td>@if($cols->hod_status != null){{$cols->hod_status}} @elseif($cols->hod_status == null && $offcial->role == "HOD") I Can't Accept this Leave Request Because It's Mine @else I Am Not Authorized to Accept this Leave Request @endif</td>
                            <td>{{$cols->hof_status}}</td>
