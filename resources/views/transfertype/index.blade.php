...
<div class="page-wrapper">
            ...
            <div class="col-12">
              <div class="card">
                <div class="card-body">
                  ...
                  <h5 class="card-title">Transfer Type List</h5>
                  <div class="">
                    <a href="{{ route('add.transfertype')}}" class="next-page">Add Transfer Type</a>
                  </div>
                  </div>
                    ...
                    >
                      ...
                      <tbody>
                          ...
                          <tr>
                            ...
                            -
                            @endif  
                            <a href="{{route('transfertype.edit',[$item->id])}}" class="fas fa-edit"></a>
                            <a href="{{route('transfertype.delete',[$item->id])}}" class="fas fa-trash delete"></a>
                          </tr>
                         @endforeach
                      </tbody>
                    </table>
     ...
     @section('script')
      <script>
        ...
        var data_transfertypeid = $(this).attr( 'data-itemid' );
        var data_status = ( ( $(this).prop("checked") == true ) ? '1' : '0' );
        $.ajax({
            type: "POST",
            url: '{{ route("transfertype.statusupdate") }}',
            data: {
                data_transfertypeid: data_transfertypeid,
