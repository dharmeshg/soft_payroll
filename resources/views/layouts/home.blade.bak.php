                ...
                <ul class="list-style-none">
                  ...
                  <li class="d-flex no-block card-body border-top">
                    ...
                    <div>
                      ...
                      >
                      <span class="text-muted"
                        >But already everything was solved. It will ../public.</span
                      >
                    </div>
                    <div class="ms-auto">
                      <div class="tetx-right">
                ...
                <div class="card-body">
                  ...
                  <div class="chat-box scrollable" style="height: 475px">
                    ...
                    <ul class="chat-list">
                      ...
                      <li class="chat-item">
                        <div class="chat-img">
                          <img src="../public/assets/images/users/2.jpg" alt="user" />
                        </div>
                        <div class="chat-content">
                      ...
                      <li class="chat-item">
                        <div class="chat-img">
                          <img src="../public/assets/images/users/3.jpg" alt="user" />
                        </div>
                        <div class="chat-content">
                ...
                <div class="tab-content tabcontent-border">
                  <div class="tab-pane active" id="home" role="tabpanel">
                    <div class="p-20">
                      ...
                      <img
                        src="../public/assets/images/background/img4.jpg"
                        class="img-fluid"
                      />
                    </div>
                  </div>
