...
<div class="page-wrapper">
                      ...
                      <tbody>                       
                         @foreach($data as $key=>$item)
                          <tr>
                            ...
                            -
                            @endif                             
                            <a href="{{route('school.edit',[$item->id])}}" class="fas fa-edit"></a>
                            <a href="{{route('school.delete',[$item->id])}}" class="fas fa-trash delete" id="delete" data-title="{{$item->name}}" data-original-title="delete School"></a></td>
                          </tr>
                         @endforeach
                      </tbody>
                    </table>
     ...
     @section('script')
      <script>
        ...
        var data_schoolid = $(this).attr( 'data-itemid' );
        ...
        $.ajax({
            type: "POST",
            url: '{{ route("StatusUpdate1") }}',
            data: {
                data_schoolid: data_schoolid,
