        ...
        <div class="container-fluid">
          <div class="card">
            <div class="card-body wizard-content">
                ...
                {{ csrf_field() }}
                @else
                <form id="example-form" action="{{ route('transferother.store')}}" method="POST" class="mt-3"autocomplete="off" data-parsley-validate="">
                {{ csrf_field() }}
                @endif
                                ...
                                <section id="steps-uid-0-p-1" role="tabpanel" aria-labelledby="steps-uid-0-h-1"
                                        ...
                                        <div class="col-6 form-group">
                                            <label for="nameofstaff">Name of Staff*</label>
                                                ...
                                                <option {{ ( isset( $transfer->nameofstaff ) && ($transfer->nameofstaff ==
                                                    $empll->id) ? 'selected' : '' ) }} value="{{$empll->id}}">{{$empll->fname}}</option>
                                                @endforeach
                                                @endforeach
                                            </select>
                                        </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-6 form-group">
                                            ...
                                            <select class="js-example-basic-single" name="transferunit" id="transferunit">
                                                <option></option>
                                                @foreach($units as $unit)
