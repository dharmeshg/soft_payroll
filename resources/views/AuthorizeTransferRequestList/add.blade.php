    ...
    <div class="container-fluid">
        <div class="card">
            <div class="card-body wizard-content">
                @if( isset( $authorizetransfer ) )
                <h4 class="card-title">Edit Authorize Transfer Request List</h4>
                @else
                <h4 class="card-title">Add Authorize Transfer Request List</h4>
                @endif

                @if( isset( $authorizetransfer ) )
                <form id="" action="{{route('authorizetransfer.update',[$authorizetransfer->id])}}" method="POST"
                    autocomplete="off" data-parsley-validate="">
                    {{ csrf_field() }}
                    @else
                    <form id="example-form" action="{{ route('authorizetransfer.store')}}" method="POST" class="mt-3"
                        autocomplete="off" data-parsley-validate="">
                        {{ csrf_field() }}
                        @endif
                        ...
                        <div role="application" class="wizard clearfix" id="steps-uid-0">
                            <div class="content clearfix transferform">
                                <section id="steps-uid-0-p-1" role="tabpanel" aria-labelledby="steps-uid-0-h-1"
                                    class="body current">
                                    <h3>Authorize Transfer Request List</h3>
                                    <div class="row">
                                        <div class="col-6 form-group">
                                            <label for="transferclass">Source Transfer Class*</label>
                                            <input type="text" class="form-control" name="transferclass" readonly value="{{$authorizetransfer->transferclass}}" required>
                                        </div>
                                        <div class="col-6 form-group">
                                            ...
                                            <select class="js-example-basic-single" name="transfertype">
                                                ...
                                                <option {{ ( isset( $authorizetransfer->transfertype ) &&
                                                    ($authorizetransfer->transfertype == $transertypes->typetitle) ? 'selected' :
                                    ...
                                    <div class="row">
                                        <div class="col-6 form-group">
                                            ...
                                            <select class="js-example-basic-single" name="transfercategory">
                                                ...
                                                <option {{ ( isset( $authorizetransfer->transfercategory ) &&
                                                    ($authorizetransfer->transfercategory == $transfercategorys->categoryname) ?
                                        ...
                                        <div class="col-6 form-group">
                                            ...
                                            <select class="js-example-basic-single" name="transferreason">
                                                ...
                                                <option {{ ( isset( $authorizetransfer->transferreason ) &&
                                                    ($authorizetransfer->transferreason == $transferreasons->transferreason) ?
                                    ...
                                    <div class="row">
                                        <div class="col-6 form-group">
                                            ...
                                            <select class="js-example-basic-single" name="nameofstaff">
                                                ...
                                                <option {{ ( isset( $authorizetransfer->nameofstaff ) && ($authorizetransfer->nameofstaff
                                                    ==
                                        ...
                                        <div class="col-6 form-group">
                                            ...
                                            <select class="js-example-basic-single" name="staffid">
                                                ...
                                                <option {{ ( isset( $authorizetransfer->staffid ) && ($authorizetransfer->staffid ==
                                    ...
                                    <div class="row transfer-form">
                                        <div class="col-6 form-group">
                                            ...
                                            <select class="js-example-basic-single" name="faculty">
                                                ...
                                                <option {{ ( isset( $authorizetransfer->faculty ) && ($authorizetransfer->faculty ==
                                        ...
                                        <div class="col-6 form-group">
                                            ...
                                            <select class="js-example-basic-single" name="department">
                                                ...
                                                <option {{ ( isset( $authorizetransfer->department ) && ($authorizetransfer->department ==
                                        ...
                                        <div class="col-6 form-group">
                                            ...
                                            <select class="js-example-basic-single" name="unit" id="unit" >
                                                <option></option>
                                                @foreach($Previousunit as $Punit)
                                                <option {{ ( isset( $authorizetransfer->unit ) && ($authorizetransfer->unit ==
                                                    $Punit->id) ? 'selected' : '' ) }} value="{{
                                                    $Punit->id }}">{{$Punit->name}}
                                                </option>
                                                @endforeach
                                            </select>
                                        ...
                                        <div class="col-6 form-group">
                                            ...
                                            <select class="js-example-basic-single" name="previous_role" id="previous_role" required>
                                                <option></option>
                                                <option {{ ( isset( $authorizetransfer->previous_role ) && ($authorizetransfer->previous_role ==
                                        ...
                                        <div class="col-6 form-group">
                                            ...
                                            <select class="js-example-basic-single" name="previous_designation" id="previous_designation" required>
                                                ...
                                                <option {{ ( isset( $authorizetransfer->previous_designation ) &&
                                                    ($authorizetransfer->previous_designation == $desigs->id) ? 'selected' : '' ) }}
                                    ...
                                    <div class="row">
                                        <div class="col-6 form-group">
                                            ...
                                            <input type="text" class="form-control" name="transferclassIn" readonly value="{{$authorizetransfer->transferclassIn}}" required>
                                        </div>
                                        <div class="col-6 form-group">
                                            ...
                                            <select class="js-example-basic-single instiorschool" name="institutionname">
                                                ...
                                                <option {{ ( isset( $authorizetransfer->institutionname ) &&
                                                    ($authorizetransfer->institutionname ==
                                                    $user->id) ? 'selected' :
                                                    '' ) }} value="{{ $user->id
                                        ...
                                        <div class="col-6 form-group">
                                            ...
                                            <select class="js-example-basic-single" name="transferfaculty">
                                                <option></option>
                                                @foreach($facultydirectorates as $facultydirectorate)
                                                <option {{ ( isset( $authorizetransfer->transferfaculty ) &&
                                                    ($authorizetransfer->transferfaculty == $facultydirectorate->id) ?
                                        ...
                                        <div class="col-6 form-group">
                                            ...
                                            <select class="js-example-basic-single" name="transferdepartment">
                                                <option></option>
                                                @foreach($departments as $department)
                                                <option {{ (isset( $authorizetransfer->transferdepartment) &&
                                                    ($authorizetransfer->transferdepartment == $department->id) ?
                                                    'selected' : '') }} value="{{$department->id}}">{{$department->departmentname}}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-6 form-group">
                                            ...
                                            <select class="js-example-basic-single" name="transferunit">
                                                ...
                                                <option {{ ( isset( $authorizetransfer->transferunit ) &&
                                                    ($authorizetransfer->transferunit == $unit->id) ? 'selected' : '' ) }}
                                        ...
                                        <div class="col-6 form-group">
                                            ...
                                            <select class="js-example-basic-single" name="role" id="role" required>
                                                <option></option>
                                                <option {{ ( isset( $authorizetransfer->role ) && ($authorizetransfer->role ==
                                                    "Employee") ? 'selected' : '' ) }} value="Employee">Employee
                                                </option>
                                                <option {{ ( isset( $authorizetransfer->role ) && ($authorizetransfer->role ==
                                                    "HOU") ? 'selected' : '' ) }} value="HOU">HOU
                                        ...
                                        <div class="col-6 form-group">
                                            ...
                                            <select class="js-example-basic-single" name="designation" id="designation" required>
                                                <option></option>
                                                @foreach($designations as $desigs)
                                                <option {{ ( isset( $authorizetransfer->designation ) &&
                                                    ($authorizetransfer->designation == $desigs->id) ? 'selected' : '' ) }}
                                                    value="{{ $desigs->id }}">{{$desigs->title}}</option>
                                                @endforeach
                                            </select>      
                                        </div>
                                    ...
                                    <div class="row">
                                      <div class="col-12 change-btn form-group form-group">
                                        <button type="submit" class="btn btn-primary submit-btn">Process</butto>
