                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-body">
                                        ...
                                        @foreach ($Department as $key => $Departments)
                                            <tr>
                                                ...
                                                <td class="thumbnail-image"><img
                                                        src="{{ asset('public/images/' . $Departments->image) }}"
                                                        style="width:150px"></td>
                                                <td>
                                                    {{-- <td>@if ($Departments->id != 1) --}}
                                                    <input type="checkbox" class="toggle" id="rounded{{ $Departments->id }}"
                            ...
                            -
                            @endif   --}}
                                                    <a href="{{ route('non_academic_department.edit', [$Departments->id]) }}"
                                                        class="fas fa-edit"></a>
                                                    <a href="{{ route('non_academic_department.delete', [$Departments->id]) }}"
...
@section('script')
    <script>
        $(document).on('change', 'input.toggle', function() {
            ...
            $.ajax({
                type: "POST",
                url: '{{ route('non_academic_department.statusupdate') }}',
                data: {
