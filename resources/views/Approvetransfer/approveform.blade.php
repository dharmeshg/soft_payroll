        ...
        <div class="page-breadcrumb">
          <div class="row">
            <div class="col-12 d-flex no-block align-items-center">
              <h4 class="page-title">Authorize Approve Request Form</h4>
                ...
                <div class="card-body">
                  ...
                  <div class="row">
                    <div class="col-3 form-group">
                      ...
                      <input type="text" class="form-control" name="" value="{{$employee->fname}}">
                  ...
                  <div class="row">
                    ...
                    <div class="col-3 form-group">
                      ...
                      <input type="text" class="form-control" name="" value="{{$employee->official_information->designation}}">
                    </div>
                    <!-- <div class="col-3 form-group">
                  ...
                  <div class="row">
                    ...
                    <div class="col-3 form-group">
                      <label>Faculty:</label>
                      <input type="text" class="form-control" name="" value="{{$transfer->faculty}}">
                    </div>
                    <div class="col-3 form-group">
                      <label>Department:</label>
                      <input type="text" class="form-control" name="" value="{{$transfer->department}}">
                    </div>
                  </div>
                  <div class="row">
                    <div class="col-3 form-group">
                  ...
                  <div class="row">
                    <div class="col-3 form-group">
                      <label>Institution Name:</label>
                      <input type="text" class="form-control" name="" value="{{$transfer->institutionname}}">
                    </div>
                    <div class="col-3 form-group">
                      <label>Faculty:</label>
                      <input type="text" class="form-control" name="" value="{{$transfer->transferfaculty}}">
                    </div>
                    <div class="col-3 form-group">
                      <label>Department:</label>
                      <input type="text" class="form-control" name="" value="{{$transfer->transferdepartment}}">
                    </div>
                    <div class="col-3 form-group">
                      <label>Unit:</label>
                      <input type="text" class="form-control" name="" value="{{$transfer->transferunit}}">
                    </div>
                  </div>
                  <div class="row">
                        <div class="col-12 change-btn form-group form-group">
                        <a href="{{route('finalapproveform',[$transfer->id])}}" class="btn btn-primary submit-btn">Approve</a>
