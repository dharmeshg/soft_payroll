    ...
    <div class="container-fluid">
        <div class="card">
            <div class="card-body wizard-content">
                ...
                @if( isset( $approvetransfer ) )
                <form id="" action="{{route('approvetransfer.update',[$approvetransfer->id])}}" method="POST"
                                ...
                                <section id="steps-uid-0-p-1" role="tabpanel" aria-labelledby="steps-uid-0-h-1"
                                    ...
                                    <div class="row">
                                      <div class="col-12 change-btn form-group form-group">
                                        <a href="{{route('approveform',[$approvetransfer->id])}}" class="btn btn-primary submit-btn">Process</a>
