    ...
    <div class="container-fluid">
        <div class="card">
            <div class="card-body wizard-content">
                @if( isset( $processtransfer ) )
                <h4 class="card-title">Edit Process Transfer</h4>
                @else
                <h4 class="card-title">Add Process Transfer</h4>
                @endif

                @if( isset( $processtransfer ) )
                <form id="" action="{{route('processtransfer.update',[$processtransfer->id])}}" method="POST"
                    autocomplete="off" data-parsley-validate="">
                    {{ csrf_field() }}
                    @else
                    <form id="example-form" action="{{ route('processtransfer.store')}}" method="POST" class="mt-3"
                        autocomplete="off" data-parsley-validate="">
                        {{ csrf_field() }}
                        @endif
                        ...
                        <div role="application" class="wizard clearfix" id="steps-uid-0">
                            <div class="content clearfix transferform">
                                <section id="steps-uid-0-p-1" role="tabpanel" aria-labelledby="steps-uid-0-h-1"
                                    class="body current">
                                    <h3>Process Transfer List</h3>
                                    <div class="row">
                                        <div class="col-6 form-group">
                                            <label for="transferclass">Source Transfer Class*</label>
                                            <input type="text" class="form-control" name="transferclass" readonly value="{{$processtransfer->transferclass}}" required>
                                        </div>
                                        <div class="col-6 form-group">
                                            ...
                                            <select class="js-example-basic-single" name="transfertype">
                                                ...
                                                <option {{ ( isset( $processtransfer->transfertype ) &&
                                                    ($processtransfer->transfertype == $transertypes->typetitle) ? 'selected' :
                                    ...
                                    <div class="row">
                                        <div class="col-6 form-group">
                                            ...
                                            <select class="js-example-basic-single" name="transfercategory">
                                                ...
                                                <option {{ ( isset( $processtransfer->transfercategory ) &&
                                                    ($processtransfer->transfercategory == $transfercategorys->categoryname) ?
                                        ...
                                        <div class="col-6 form-group">
                                            ...
                                            <select class="js-example-basic-single" name="transferreason">
                                                ...
                                                <option {{ ( isset( $processtransfer->transferreason ) &&
                                                    ($processtransfer->transferreason == $transferreasons->transferreason) ?
                                    ...
                                    <div class="row">
                                        <div class="col-6 form-group">
                                            ...
                                            <input type="hidden" class="form-control" name="nameofstaff" readonly value="{{$emp->id}}" required>
                                            ...
                                            <select class="js-example-basic-single" name="nameofstaff">
                                                ...
                                                <option {{ ( isset( $processtransfer->nameofstaff ) && ($processtransfer->nameofstaff
                                                    ==
                                        ...
                                        <div class="col-6 form-group">
                                            ...
                                            <select class="js-example-basic-single" name="staffid">
                                                ...
                                                <option {{ ( isset( $processtransfer->staffid ) && ($processtransfer->staffid ==
                                    ...
                                    <div class="row transfer-form">
                                        <div class="col-6 form-group">
                                            ...
                                            <select class="js-example-basic-single" name="faculty">
                                                ...
                                                <option {{ ( isset( $processtransfer->faculty ) && ($processtransfer->faculty ==
                                        ...
                                        <div class="col-6 form-group">
                                            ...
                                            <select class="js-example-basic-single" name="department">
                                                ...
                                                <option {{ ( isset( $processtransfer->department ) && ($processtransfer->department ==
                                                    $department->departmentname) ? 'selected' : '' ) }} value="{{
                                        ...
                                        <div class="col-6 form-group">
                                           ...
                                           @if(Auth::user()->role == 'Employee' || Auth::user()->role == 'HOU' || Auth::user()->role == 'HOD' || Auth::user()->role == 'HOF')
                                            ...
                                            <select class="js-example-basic-single" name="unit" id="unit" required>
                                                ...
                                                <option {{ ( isset( $processtransfer->unit ) && ($processtransfer->unit ==
                                        ...
                                        <div class="col-6 form-group">
                                           ...
                                           <input type="text" class="form-control" name="previous_role" value="{{isset($emp->official_information) ? $emp->official_information->role : ''}}" readonly required>
                                            ...
                                            <select class="js-example-basic-single" name="previous_role" id="previous_role" required>
                                                <option></option>
                                                <option {{ ( isset( $processtransfer->role ) && ($processtransfer->role ==
                                        ...
                                        <div class="col-6 form-group">
                                            ...
                                            <select class="js-example-basic-single" name="previous_designation" id="previous_designation" required>
                                                ...
                                                <option {{ ( isset( $processtransfer->previous_designation ) &&
                                                    ($processtransfer->previous_designation == $desigs->id) ? 'selected' : '' ) }}
                                    ...
                                    <div class="row">
                                        <div class="col-6 form-group">
                                            ...
                                            <input type="text" class="form-control" name="transferclassIn" readonly value="{{$processtransfer->transferclassIn}}" required>
                                        </div>
                                        <div class="col-6 form-group">
                                            ...
                                            <select class="js-example-basic-single instiorschool" name="institutionname">
                                                ...
                                                <option {{ ( isset( $processtransfer->institutionname ) &&
                                                    ($processtransfer->institutionname ==
                                                    $user->id) ? 'selected' :
                                                    '' ) }} value="{{ $user->id
                                        ...
                                        <div class="col-6 form-group">
                                            ...
                                            <select class="js-example-basic-single" name="transferfaculty">
                                                <option></option>
                                                @foreach($facultydirectorates as $facultydirectorate)
                                                <option {{ ( isset( $processtransfer->transferfaculty ) &&
                                                    ($processtransfer->transferfaculty == $facultydirectorate->id) ?
                                        ...
                                        <div class="col-6 form-group">
                                            ...
                                            <select class="js-example-basic-single" name="transferdepartment">
                                                <option></option>
                                                @foreach($departments as $department)
                                                <option {{ ( isset( $processtransfer->transferdepartment ) &&
                                                    ($processtransfer->transferdepartment == $department->id) ?
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-6 form-group">
                                            ...
                                            <select class="js-example-basic-single" name="transferunit">
                                                <option></option>
                                                @foreach($units as $unit)
                                                <option {{ ( isset( $processtransfer->transferunit ) &&
                                                    ($processtransfer->transferunit == $unit->id) ? 'selected' : '' ) }}
                                        ...
                                        <div class="col-6 form-group">
                                            ...
                                            <select class="js-example-basic-single" name="designation" id="designation" required>
                                                <option></option>
                                                @foreach($designations as $desigs)
                                                <option {{ ( isset( $processtransfer->designation ) &&
                                                    ($processtransfer->designation == $desigs->id) ? 'selected' : '' ) }}
                                                    value="{{ $desigs->id }}">{{$desigs->title}}</option>
                                                @endforeach
                                            </select>      
                                        </div>
